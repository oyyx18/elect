<template>
  <n-modal v-model:show="visible" preset="card" title="模型调试" class="w-80% h-800px">
                ...
                <n-grid :cols="24" :x-gap="24" class="ml-24px">
                  <n-form-item-gi :span="24" :label="val.formName" :path="val.serverKey" v-if="val.type !== 'log'">
                    <component :is="getFormComponent(val.type, val.value, val)"
                      ...
                      :logData="val.logData" :isMultiple="val.isMultiple" :columns="val.columns" :data="val.query" :items="netWorkList"
...
import { debugModel, savaDebugLog } from '@/service/api/third';
