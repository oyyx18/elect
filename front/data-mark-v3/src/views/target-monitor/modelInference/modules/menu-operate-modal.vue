...
<template>
  <NModal v-model:show="visible" title="异常区域详情" preset="card" class="w-800px">
    <NScrollbar class="h-280px pr-20px">
      <NForm ref="formRef" :model="model" :rules="rules" label-placement="left" :label-width="100">
        <NGrid responsive="screen" item-responsive>
          <NFormItemGi span="24 m:24" label="任务名称:" path="menuType">
            {{ model.taskName}}
          </NFormItemGi>
          <NFormItemGi span="24 m:24" label="进度:" path="menuType">
            {{ model.taskProgress}}
          </NFormItemGi>
          <NFormItemGi span="24 m:24" label="任务状态:" path="menuType">
            {{ model.taskStat}}
          </NFormItemGi>
          <NFormItemGi span="24 m:24" label="参数:" path="menuType">
            {{ model.params}}
          </NFormItemGi>
        </NGrid>
      </NForm>
