...
const {
  ...
  columns: () => [
    ...
    { title: "关联数据集名称", key: "groupVName", width: 180, },
    // {
    //   title: "版本",
    //   key: "version",
    //   width: 100,
...
onMounted(() => {
  ...
  getTaskPage({ page: 1, limit: 10, modelId: 4 }).then((res) => {
...
<template>
  <div class="min-h-500px flex-col-stretch gap-16px overflow-hidden lt-sm:overflow-auto">
    ...
    <NCard title="异常区域" :bordered="false" size="small" class="sm:flex-1-hidden card-wrapper">
