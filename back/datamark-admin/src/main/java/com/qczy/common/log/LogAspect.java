...
import com.qczy.utils.GetUserUtils;

import com.qczy.utils.IpUtils;
import com.qczy.utils.ServletUtils;
...
public class LogAspect {
        ...
        try {
            ...
            if (e != null) {
                ...
                if (StringUtils.isNotNull(jsonResult)) {
                    ...
                    cn.hutool.json.JSONObject json = new cn.hutool.json.JSONObject(jsonResult);
                    log.info("json:{}", json);
                    String code = json.getStr("code");
                    String data = json.getStr("data");
                    if (StringUtils.isNotBlank(code) && code.equals("500")) {
                        operLog.setStatus(BusinessStatus.FAIL.ordinal());
                        operLog.setErrorMsg(data);
                    }
     ...
     * @throws Exception
     */
    public void getControllerMethodDescription(JoinPoint joinPoint, Log log, OperLogEntity operLog, Object jsonResult) throws Exception {
        // 设置action动作
     ...
     * @throws Exception 异常
     */
    private void setRequestValue(JoinPoint joinPoint, OperLogEntity operLog, String[] excludeParamNames) throws Exception {
